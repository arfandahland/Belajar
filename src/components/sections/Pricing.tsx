...
/**
 * ⚡ BOLT OPTIMIZATION:
 * We use React.memo to prevent unnecessary re-renders of the Pricing section.
 * Re-rendering complex layouts like pricing tables is expensive and should be minimized.
 */
