...
export default function Home() {
  ...
  // BOLT OPTIMIZATION: Use deferred value for the preview data to keep sidebar inputs
  // responsive while typing, allowing React to prioritize the "urgent" state update
  // of the inputs before re-rendering the heavy preview area.
