...
export default function Home() {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION:
   * We use useDeferredValue to decouple the immediate state updates in the Sidebar
   * from the potentially expensive re-renders of the Preview area.
   * This ensures the editor inputs remain snappy and responsive even as the landing page grows complex.
   */
