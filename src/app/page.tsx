...
export default function Home() {
  ...
  /**
   * Use useDeferredValue for the landing page state passed to preview sections.
   * This ensures that sidebar inputs remain responsive during frequent updates
   * by deferring the more expensive preview re-renders.
   */
