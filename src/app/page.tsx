...
export default function Home() {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION:
   * useDeferredValue is used to prioritize UI responsiveness in the Sidebar.
   * By deferring the update of the Preview area, we ensure that keystrokes
   * in the Input/Textarea fields remain snappy, while the potentially
   * expensive re-render of the landing page sections is handled as a
